...
//Creates cards with messages and appends them to page
function cardFactory(heading, message) {
    //List out all possible card colour classes
    let randomCardColour = ["is-primary", "is-link", "is-info", "is-success", "is-warning", "is-danger"];
    ...
    //Pick random floored number between 0 and length of card colours and phrase
...
//--- Functions to enable or disable the submit button depending on phones network status
